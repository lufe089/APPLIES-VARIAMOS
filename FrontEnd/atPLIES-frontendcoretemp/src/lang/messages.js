...
export default {
    en: {
        message: {
            ...
            total: 'total',
            why_question: 'Why?',
            welcome_to_applies: '<h2><span style="color: #3d94ff;"><strong>Welcome!</strong></span> <span style="font-family: Playfair Display, sans-serif;">This tool provides support to the APPLIES framework</span></h2>',
